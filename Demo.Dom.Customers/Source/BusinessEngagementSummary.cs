...
namespace Demo.Dom.Customers
{
    ...
    [MetadataType(typeof(BusinessEngagementSummary_Metadata))]
    public partial class BusinessEngagementSummary
    {
        ...
        [NotPersisted]
        public IBusinessEngagement EngagementDetail
        {
            get { return BusinessEngagementCompoundKey == null ? null : ObjectFinder.FindObject<IBusinessEngagement>(BusinessEngagementCompoundKey); }
        }

        [NotPersisted]
        protected string BusinessEngagementCompoundKey
        {
            get { return TypeName + "|" + InstanceIdentifier; }
        }
    ...
    public class BusinessEngagementSummary_Metadata
    {
